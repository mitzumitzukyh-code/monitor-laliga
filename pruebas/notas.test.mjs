...
// Brier normalizado por 3 clases (fórmula oficial de PLAN.md): 0.38 / 3 = 0.126666...
...
test('predicción totalmente errada (confianza 1 en la clase equivocada) da brier=2/3 (el máximo real, no 1)', () => {
